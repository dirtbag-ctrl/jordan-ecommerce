...
CREATE TABLE `orders_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_orders_has_products_product1_idx` (`product_id`),
  ...
  CONSTRAINT `fk_orders_has_products_product1` FOREIGN KEY (`product_id`) REFERENCES `product` (`prod_id`) ON DELETE CASCADE ON UPDATE CASCADE
